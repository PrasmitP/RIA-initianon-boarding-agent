...
async function generateDocument(
  ...
  const prompts = {
    'risk-profile': `Generate a comprehensive Client Risk Profile document based on the following client information:
...
Format in markdown.`,
    ...
    'goals-brief': `Generate a comprehensive Financial Goals Brief based on:
...
Format in markdown.`,
    ...
    'planning-agenda': `Create a comprehensive Client Planning Meeting Agenda for:
...
Format in markdown.`,
    ...
    'draft-ips': `Generate a comprehensive Draft Investment Policy Statement (IPS) for:
